...
var ForceGraphFilter = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            "     ",
            React.createElement(AttributesFilter, {
            ...
            React.createElement("br", null),
            React.createElement(OptionsFilter, {
            ...
            React.createElement(
                "div",
                null,
                React.createElement("input", { type: "button", className: "col-sm-2 btn", value: "Сбросить выделенные узлы", onClick: this.handleResetClick }),
                React.createElement(
                    "div",
                    { className: "col-sm-10" },
                    React.createElement("input", { value: this.state.filterNodes, className: "form-control", type: "text", placeholder: "Nodes list", id: "disabledInput", disabled: true })
                )
            ),
            React.createElement("br", null)
        );
...
var OptionsFilter = React.createClass({
    displayName: "OptionsFilter",

    getInitialState: function () {
        return {
            zeroDegreeProperties: [{ value: 'true', display: 'Убирать узлы без связей', checked: true }, { value: 'false', display: 'отображать', checked: false }],
            nodeRadiusProperties: [{ value: 'byDegree', display: 'Радиус узла по весу', checked: true }, { value: 'byAttributes', display: 'по кол-ву атрибутов', checked: false }],
    ...
    render: function () {
        return React.createElement(
            "div",
            null,
            React.createElement(CMRadioGroup, {
                name: "zero",
...
var AttributesFilter = React.createClass({
    ...
    render: function () {
        return React.createElement(CMCheckboxGroup, {
            name: "attributes",
...
React.render(React.createElement(ForceGraphFilter, null), document.getElementById('force-filter'));