...
var Attribute = React.createClass({displayName: "Attribute",
    render: function() {
        return (
            React.createElement("div", null, this.props.display)
        );
    }
});
...
var AttributesList = React.createClass({displayName: "AttributesList",
  render: function() {
    var commentNodes = this.props.data.map(function (comment) {
      return (
        React.createElement(Attribute, {attributes: ATTRIBUTES})
      );
    });
    return (
...
React.render(
    React.createElement(FilterableProductTable, {products: PRODUCTS, url: "json-attributes"}), 
