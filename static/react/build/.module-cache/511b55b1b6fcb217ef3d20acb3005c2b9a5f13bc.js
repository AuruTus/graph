if (gid  != "None" && gid != "") {
    var links = [
        ...
        {'link': '/timeline/' + gid, 'title': 'Многомерный тренд'},
            ...
            React.createElement("nav", {className: "navbar navbar-inverse navbar-fixed-top"}, 
                React.createElement("div", {className: "container"}, 
                    React.createElement("div", {className: "navbar-header"}, 
                        React.createElement("a", {className: "navbar-brand", href: "/"}, "Проекты")
                    ), 
                    React.createElement("div", {id: "navbar", className: "navbar-collapse collapse"}, 
                        ...
                        React.createElement("ul", {className: "nav navbar-nav navbar-right"}, 
                            React.createElement("li", null, React.createElement("a", {href: "/new-project"}, "Создать проект"))
                        )
                    )
                )
            )
