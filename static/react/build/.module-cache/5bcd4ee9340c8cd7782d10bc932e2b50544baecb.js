...
var NodeBar = React.createClass({displayName: "NodeBar",
    ...
    render: function() {
        ...
        return (
            React.createElement("g", {className: "NodeBar"}, 
                ...
                React.createElement("text", {x: 10, y: this.state.yoffset+20}, this.props.data), 
                React.createElement("text", {x: globOffset-18, y: this.state.yoffset+20}, this.state.transfersSum), 
                React.createElement("text", {x: this.props.width+globOffset+3, y: this.state.yoffset+20}, this.props.transfersNumber), 
                rows
            )
        )
    },
...
var NavBar = React.createClass({displayName: "NavBar",
    ...
    render: function() {
        ...
        this.state.months.forEach(function(month, key) {
            rows.push(React.createElement(NavBarUnit, {
                key: key, 
                reactKey: key, 
                month: month, 
...
var NavBarUnit = React.createClass({displayName: "NavBarUnit",
    getDefaultProps: function() {
        return {
            width: 40,
            height: 40,
    ...
    render: function() {
        return (
            React.createElement("g", {
                ...
                React.createElement("text", {x: this.state.x+this.props.width/2-5, y: this.props.height/2+5}, this.props.month)
            )
        )
    },
})
...
React.render( React.createElement(Timeline, null), TimeLine)
