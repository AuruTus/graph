    ...
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("form", {onSubmit: this.handleSubmit, ref: "forceGraphFilterForm", className: "form-inline"}, 
                    React.createElement(TaxonomyFilter, {ref: "theTaxonomyFilter"}), 
                    React.createElement(OptionsFilter, {updateOptions: this.updateOptions}), 
                    React.createElement(Stopper, {ref: "theStopper"}), 
...
var AttributesFilter = React.createClass({displayName: "AttributesFilter",
...
var Stopper = React.createClass({displayName: "Stopper",
    getInitialState: function() {
        return {value: '50'};
    },
    ...
    render: function() {
        ...
        return (
            React.createElement("input", {type: "text", value: value, onChange: this.handleChange, className: "form-control col-sm-2"})
        )
    },
})


var OptionsFilter = React.createClass({displayName: "OptionsFilter",
    getInitialState: function() {
        return {
            // ассоциативный массив данных, полученный с сервера в формате json
            properties: [
    ...
    render: function() {
        return (
            React.createElement(CMCheckboxGroup, {name: "options", properties: this.state.properties, onChange: this.handleChange})
        );
    },
})
...
var TaxonomyFilter = React.createClass({displayName: "TaxonomyFilter",
...
React.render( React.createElement(NewProjectFilter, null), mountNewProject)
