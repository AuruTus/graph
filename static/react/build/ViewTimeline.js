...
var NodeBar = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "text",
                { x: 10, y: this.state.yoffset + 20 },
                this.props.data
            ),
            React.createElement(
                "text",
                { x: globOffset - 18, y: this.state.yoffset + 20 },
                this.state.transfersSum
            ),
            React.createElement(
                "text",
                { x: this.props.width + globOffset + 3, y: this.state.yoffset + 20 },
                this.props.transfersNumber
            ),
            rows
        );
    }
...
var NavBarUnit = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                "text",
                { x: this.state.x + this.props.width / 2 - 5, y: this.props.height / 2 + 5 },
                this.props.month
            )
        );
    }
...
var GraphFilter = React.createClass({
    ...
    render: function () {
        return React.createElement(
            "form",
            { onSubmit: this.handleSubmit, ref: "GraphFilterForm" },
