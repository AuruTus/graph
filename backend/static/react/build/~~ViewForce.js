...
function ForceLayout(containerID, id, graphFilter) {
    ...
    this.force = d3.layout.force().charge(-20).linkDistance(30).size([width, height]);

    this.svg = d3.select(containerID).append("svg").attr("width", width).attr("height", height).append("g");
