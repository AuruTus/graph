...
var CMRadioGroupButton = React.createClass({
    displayName: 'CMRadioGroupButton',
...
var RecursiveCheckboxTree = React.createClass({
    displayName: 'RecursiveCheckboxTree',
    ...
    render: function () {
        ...
        this.props.children.forEach(function (term, key) {
            ...
            rows.push(React.createElement(RecursiveCheckboxTree, {
                key: term.tid,
