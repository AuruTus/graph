var NewProjectFilter = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                'form',
                { onSubmit: this.handleSubmit, ref: 'forceGraphFilterForm', className: 'form-inline' },
...
var Stopper = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement('input', { type: 'text', value: value, onChange: this.handleChange, className: 'form-control col-sm-2' });
    }
});
...
var OptionsFilter = React.createClass({
    ...
    getInitialState: function () {
        return {
            // ассоциативный массив данных, полученный с сервера в формате json
            properties: [{ "checked": true, "display": "Убирать узлы без связей", "value": 'removeZero' }],
            optionsState: {}
        };
    },
    handleChange: function (checkboxGroupState) {
    ...
    render: function () {
        return React.createElement(CMCheckboxGroup, { name: 'options', properties: this.state.properties, onChange: this.handleChange });
    }
});
