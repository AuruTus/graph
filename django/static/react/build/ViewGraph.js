...
var Filter = React.createClass({
    ...
    handleSubmit: function (e) {
        ...
        if (typeof this.props._handleSubmit === 'function') {
            ...
            //console.log('FILTER',filter)
            if (typeof (func = this.props._handleSubmit) === 'function') {
                func(filter);
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                'form',
                { onSubmit: this.handleSubmit, ref: 'forceGraphFilterForm', className: 'taxonomy' },
                ...
                React.createElement(
                    'div',
                    { className: 'RecursiveCheckboxTree' },
...
var Attributes = React.createClass({
    ...
    updateFilter(key, value) {
        this.constructor.filter[key] = value;
        if (typeof (func = this.props._updateFilterState) === 'function') {
            func('attributes', this.constructor.filter);
        }
    },
    render: function () {
...
var AttributesLabel = React.createClass({
    ...
    componentDidMount: function () {
        if (typeof (func = this.props._updateFilterState) === 'function') {
            func(this.props.value, this.state.checked);
        }
    },
...
var JoinPersons = React.createClass({
    displayName: 'JoinPersons',

    getInitialState: function () {
        var isChecked = false;
        if (typeof (func = this.props._updateFilter) === 'function') {
            func('joinPersons', isChecked);
        }
...
var Position = React.createClass({
    ...
    getInitialState: function () {
        ...
        return {
            // Ассоциативный массив данных, полученный с сервера в формате json
            data: [{ 'tid': 1, 'value': 'Президент', 'display': 'Президент', 'checked': true }, { 'tid': 2, 'value': 'Премьер', 'display': 'Премьер', 'checked': true }, { 'tid': 3, 'value': 'Министр', 'display': 'Министр', 'checked': true }, { 'tid': 4, 'value': 'Губернатор', 'display': 'Губернатор', 'checked': true }, { 'tid': 5, 'value': 'Чиновник', 'display': 'Чиновник', 'checked': true }, { 'tid': 6, 'value': 'Депутат', 'display': 'Депутат', 'checked': true }, { 'tid': 7, 'value': 'Журналист', 'display': 'Журналист', 'checked': true }, { 'tid': 8, 'value': 'Активист', 'display': 'Активист', 'checked': true }, { 'tid': 9, 'value': 'Конструктор', 'display': 'Конструктор', 'checked': true }]
        };
    },
    render: function () {
        return React.createElement(
...
var Layout = React.createClass({
    ...
    handleChange(e) {
        ...
        if (typeof (func = this.props._submit) === 'function') {
            func(e);
        }
    },
    render: function () {
...
var SVGScene = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                'symbol',
                { id: 'organization-icon', viewBox: '0 0 22 22' },
                React.createElement('path', { d: 'M32 6.076c-1.177 0.522-2.443 0.875-3.771 1.034 1.355-0.813 2.396-2.099 2.887-3.632-1.269 0.752-2.674 1.299-4.169 1.593-1.198-1.276-2.904-2.073-4.792-2.073-3.626 0-6.565 2.939-6.565 6.565 0 0.515 0.058 1.016 0.17 1.496-5.456-0.274-10.294-2.888-13.532-6.86-0.565 0.97-0.889 2.097-0.889 3.301 0 2.278 1.159 4.287 2.921 5.465-1.076-0.034-2.088-0.329-2.974-0.821-0.001 0.027-0.001 0.055-0.001 0.083 0 3.181 2.263 5.834 5.266 6.437-0.551 0.15-1.131 0.23-1.73 0.23-0.423 0-0.834-0.041-1.235-0.118 0.835 2.608 3.26 4.506 6.133 4.559-2.247 1.761-5.078 2.81-8.154 2.81-0.53 0-1.052-0.031-1.566-0.092 2.905 1.863 6.356 2.95 10.064 2.95 12.076 0 18.679-10.004 18.679-18.68 0-0.285-0.006-0.568-0.019-0.849 1.283-0.926 2.396-2.082 3.276-3.398z', fill: '#000000' })
            ),
            React.createElement(
                'g',
                { className: 'edges' },
...
var ScaleNav = React.createClass({
    displayName: 'ScaleNav',

    handleClick(e, sign) {
        if (typeof (func = this.props._sceneClicked) === 'function') {
            func();
        }
        if (typeof (func = this.props._handleClick) === 'function') {
            func(e, sign);
        }
    },
    render: function () {
...
var ScaleNavPlus = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'g',
            { className: 'scale-nav-plus', onClick: this.handleClick },
            React.createElement(
                'g',
                null,
...
var ScaleNavMinus = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'g',
            { className: 'scale-nav-minus', onClick: this.handleClick },
            React.createElement(
                'g',
                null,
    ...
    */
    onClick: function () {
        ...
        if (typeof (func = this.props._handleNodeClick) === 'function') {
            func(this.props.nid, checked, this.props.data, this.props.attributes);
        }
    },
    handleMouseDown(e) {
...
var GraphNodeOrganization = React.createClass({
    displayName: 'GraphNodeOrganization',
