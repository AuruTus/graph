...
urlpatterns += [
    ...
    url(r'^force/(?P<id>[-\w]+)/(?P<graphFilter>.*)/$', 'zcore.views.view_force', name='viewForce'),
    ...
    url(r'^json-forced3/(?P<id>[-\w]+)/(?P<graphFilter>.*)/$', 'zcore.views.json_forced3', name='jsonForced3'),
